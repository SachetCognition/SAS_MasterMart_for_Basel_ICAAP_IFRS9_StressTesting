"""
RST Property Investment/Development stress.

Translated from Code/04.RST_SEGMENT/F_07_RST_PROP_INVDEV.sas.
"""
...
def run(config: Config, prty_inv: pl.DataFrame, params: RSTParameters) -> pl.DataFrame:
    """Apply RST stress to Property Investment/Development segment."""
    if prty_inv.is_empty():
        logger.warning("F07 RST: Empty PRTY_INV segment")
        return prty_inv
    ...
    logger.info("F07 RST: PRTY_INV stress: %d rows", len(df))
    return df
